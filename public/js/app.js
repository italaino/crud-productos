...
__webpack_require__(/*! ./miScript */ "./resources/js/miScript.js");
...
function Hola() {
  var botones_eliminar = document.querySelectorAll('.btn_eliminar');
  botones_eliminar.addEventListener('click', function () {
    alert('click');
    console.log('click');
  });
}
